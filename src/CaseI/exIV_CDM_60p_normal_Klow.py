...
class CDM(THMPropagationModel, pp.THM):
    ...
    def _set_fields(self, params):
        ...
        self.initial_aperture = 2e-3 / self.length_scale   # virkar ekki fyrir 1e-3 i CaseII
        self.gravity_on = True
        self.T_gradient = 13e-2 * self.length_scale
        # Define the domain
    ...
    def _depth(self, coords) -> np.ndarray:
        ...
        """
        return 2.4 * pp.KILO * pp.METER - self.length_scale * coords[2]
    ...
    def _set_time_parameters(self):
        ...
        self.time = 0
        # and time step
        self.time_step = 3 * pp.YEAR

        # We use
        self.end_time = 60 * pp.YEAR
...
if __name__ == "__main__":
    ...
    folder_name = "CaseI_sh_60p_normal_Klow"
    params = {
        "folder_name": folder_name,
        "nl_convergence_tol": 5e-6, #1e-6 virkar ekki
        "max_iterations": 60,
