...
class CDM(THMPropagationModel, pp.THM):
    ...
    def _set_fields(self, params):
        ...
        self.initial_aperture = 2e-3 / self.length_scale   # virkar ekki fyrir 1e-3
        self.gravity_on = True
        self.T_gradient = 8e-2 * self.length_scale
        # Define the domain
    ...
    def _depth(self, coords) -> np.ndarray:
        ...
        """
        return 1.4 * pp.KILO * pp.METER - self.length_scale * coords[2]
...
if __name__ == "__main__":
    ...
    folder_name = "CaseII_sh_60p_normal_Klow"
    params = {
