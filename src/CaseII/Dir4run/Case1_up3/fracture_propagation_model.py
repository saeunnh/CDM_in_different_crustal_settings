...
class THMPropagationModel(TensilePropagation):
    ...
    def _set_fields(self, params):
        ...
        self.T_0_Kelvin = 530 # sirka 260 deg_C
...
class Water:
    ...
    def __init__(self, theta_ref=None):
        ...
        self.VISCOSITY = 0.11 * pp.MILLI * pp.PASCAL * pp.SECOND
...
class Granite(pp.Granite):
    ...
    def __init__(self, theta_ref=None):
        ...
        self.PERMEABILITY = 1e-17   # ch. to be on save site
        ...
        self.THERMAL_EXPANSION = 5e-5 # 80-100 grad_C
